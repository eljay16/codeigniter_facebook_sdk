...
Class Facebook
{
    ...
    /*
     * Follow Pages on facebook if they're log in 
     * This will return iframe if they're authenticated else it will return nothing
     * For more information about the parameter visit https://developers.facebook.com/docs/plugins/follow-button
     *
     */
    public function like_page($page_url,$action='like', $share=false,$show_faces = false,$size='small',$width=450, $height=80){
        return '<iframe src="https://www.facebook.com/plugins/like.php?href='.$page_url.'&layout=standard&action='.$action.'&size='.$size.'&show_faces='.$show_faces.'&share='.$share.'&height=80&appId='.$this->config->item('facebook_app_id').'" width="450" height="80" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true"></iframe>';
    }
    public function follow_page($page_url,$layout='standard', $share=false,$show_faces = false,$size='small',$width=450, $height=80){
        return '<iframe src="https://www.facebook.com/plugins/follow.php?href='.$page_url.'&layout='.$layout.'&size='.$size.'&show_faces='.$show_faces.'&appId='.$this->config->item('facebook_app_id').'" width="450" height="80" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true"></iframe>';
         // return '<iframe src="https://www.facebook.com/plugins/follow.php?href=https%3A%2F%2Fwww.facebook.com%2Fzuck&width=450&height=80&layout=standard&size=small&show_faces=true&appId=1795815103996685" width="450" height="80" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true"></iframe>';
    }
    public function post_link_on_profile($message,$url){
        $linkData = [
          'link' => $url,
          'message' => $message,
          ];
        ...
        try {
          ...
          echo 'Facebook SDK returned an error: ' . $e->getMessage() .'Does the user already logged in?';
          exit;
        }
