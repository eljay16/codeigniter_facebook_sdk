...
$config['facebook_app_id']              = '1795815103996685';
$config['facebook_app_secret']          = '7dcf7df0ec37ee7b9b9a6d5a4a9505a4';
$config['facebook_login_type']          = 'web';
$config['facebook_login_redirect_url']  = 'index.php/facebookauth/login';
$config['facebook_logout_redirect_url'] = 'index.php/facebookauth/logout';
